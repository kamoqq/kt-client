...
Rpc.prototype.void = function(callback) {
  this._call('void', undefined, {}, function(error) {
    callback(error);
  });
};
...
Rpc.prototype.matchPrefix = function(prefix, options, callback) {
  ...
  params.prefix = encodeURIComponent(prefix);
...
Rpc.prototype.matchRegex = function(regex, options, callback) {
  ...
  params.regex = encodeURIComponent(regex);
  params.regex = regex;

  if (typeof opt.db !== 'undefined') {
    params.DB = encodeURIComponent(opt.db);
    params.DB = opt.db;
  }
