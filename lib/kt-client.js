 ...
 * @param {callback} callback - the callback
 */
KyotoTycoon.prototype.cas = function (key, oldValue, newValue, options, callback) {
  this.rpc.cas(key, options, callback);
};
 ...
 * @param {callback} callback - the callback
 */
KyotoTycoon.prototype.matchSimilar = function (origin, options, callback) {
