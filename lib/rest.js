...
Rest.prototype.get = (key, options, callback) => {
  let opt;
  let cb;
...
Rest.prototype.set = (key, value, options, callback) => {
  this._put(key, value, 'set', options, callback);
};

Rest.prototype.add = (key, value, options, callback) => {
  this._put(key, value, 'add', options, callback);
};

Rest.prototype.replace = (key, value, options, callback) => {
  this._put(key, value, 'replace', options, callback);
};

Rest.prototype.remove = (key, options, callback) => {
  let opt;
  let cb;
...
Rest.prototype._put = (key, value, mode, options, callback) => {
  let val;
  let opt;
  let cb;
  let date;
...
Rest.prototype._buildPath = (key, db) => {
